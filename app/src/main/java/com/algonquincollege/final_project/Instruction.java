...
public class Instruction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text += "Instructions: You can search for the calories and fat content of a food. You can add it to your favourite\n" +
                "    list. On your list, you can retrieve the nutrition information of a selected food. You can also deleteStopButton an item on your favourite list from the details page. You can\n" +
